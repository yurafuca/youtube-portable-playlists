class Nicoapi
{
    ...
    static isLogined() {
        return new Promise(function(resolve, reject) {
            $.post('http://www.nicovideo.jp/api/mylistgroup/list', function(response) {
    ...
    static getDeflistItem() {
        return new Promise(function(resolve, reject) {
            $.post('http://www.nicovideo.jp/api/deflist/list', function(response) {
    ...
    static getMylistItem(listId) {
        return new Promise(function(resolve, reject) {
            $.post('http://www.nicovideo.jp/api/mylist/list?group_id=' + listId, function(response) {
                console.log(response.mylistitem);
                switch (response.status) {
                    case 'ok':
                        resolve(response.mylistitem);
